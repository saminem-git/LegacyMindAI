// Shared types mirrored from packages/shared for frontend use
...
export type FindingType =
  | 'CIRCULAR_DEPENDENCY' | 'ORPHAN_DEPENDENCY' | 'CRITICAL_RULE_NO_TEST'
  | 'DUPLICATE_BUSINESS_LOGIC' | 'DEAD_CODE' | 'PARITY_MISMATCH'
  | 'RETIRED_INTEGRATION' | 'ORPHAN_DATA_STORE' | 'SECURITY_RISK'
  | 'CONTINUITY_RISK' | 'LOW_CONFIDENCE_RULE' | 'UNDOCUMENTED_MODULE' | 'HIGH_COMPLEXITY';
